...
(A) .Rmd Line numbers where at least two different data sources are imported: 32, 93


(B) .Rmd Line numbers for inspecting data intake: 78, 82, 129, 133
...
(A) .Rmd Line number(s) for general data wrangling: 52, 62, 232, 285


(B) .Rmd Line number(s) for a join operation: 144


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):


(D) .Rmd Line number(s) for use of regular expressions: 121


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 233, 254
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 315, 320
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 165, 239

(B) .Rmd Line number(s) for use of multiple aesthetics: 164, 165, 178

(C) .Rmd Line number(s) for use of layered graphics: 194, 240
